        ...
        <x-slot:title>Kontakt</x-slot>
            ...
            <form action="{{ route('pages.contacts.store') }}" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="subject" id="subject" value="{{ old('subject') }}" placeholder="Temat wiadomości">
                    @error('subject')
                    <div>{{ $message }}</div>
                    @enderror
                </div>
                <div>
                    ...
                    <textarea name="content" id="content" placeholder="Treść wiadomości">{{ old('content') }}</textarea>
                    @error('content')
                    <div>{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="E-mail">
                    @error('email')
                    <div>{{ $message }}</div>
                    @enderror
                </div>
