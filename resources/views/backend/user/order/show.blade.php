<x-app-layout>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <table class="w-full">
                        <tbody>
                            ...
                            <tr>
                                <x-table-data>Złożono</x-table-data>
                                <x-table-data>{{ $item->created_at->format("m.d.Y") }}</x-table-data>
                            </tr>
                        </tbody>
                    </table>
                    <x-btn-group>
                        <x-link href="{{ route('backend.users.orders.index') }}">Powrót</x-link>
                    </x-btn-group>
                </div>
            </div>
        </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xs sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <x-header-three>Produkty</x-header-three>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <x-table-header>Nazwa</x-table-header>
                                <x-table-header>Typ</x-table-header>
